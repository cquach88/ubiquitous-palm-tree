...
export const RANK_INFO: Record<Rank, RankInfo> = {
  general: { vi: 'Tướng', glyph: '將' },
  advisor: { vi: 'Sĩ', glyph: '士' },
  elephant: { vi: 'Tượng', glyph: '象' },
  chariot: { vi: 'Xe', glyph: '車' },
  cannon: { vi: 'Pháo', glyph: '砲' },
  horse: { vi: 'Mã', glyph: '馬' },
  pawn: { vi: 'Tốt', glyph: '卒' },
};

export const COLOR_INFO: Record<Color, { vi: string }> = {
  red: { vi: 'đỏ' },
  green: { vi: 'xanh' },
  yellow: { vi: 'vàng' },
  white: { vi: 'trắng' },
